"""
Django settings for somo_43097 project.
...
WSGI_APPLICATION = 'somo_43097.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "somo_43097 API",
    "DESCRIPTION": "API documentation for somo_43097 App",
    "VERSION": "v1",
}
